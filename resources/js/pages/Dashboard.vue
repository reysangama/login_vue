...
<<<<<<< HEAD
    <div
        class="wrapper theme-1-active pimary-color-green"
        :class="{
            ' slide-nav-toggle': state_navbar,
            '': !state_navbar,
            'mobile-nav-open': state_nav,
            '': !state_nav,
        }"
    >
        <!-- Top Menu Items -->
        <nav class="navbar navbar-inverse navbar-fixed-top">
            <div class="mobile-only-brand pull-left" >
                ...
                ></a>
                <a class="mobile-only-view" @click="clickNav" href="#"
            ...
            <div id="mobile_only_nav" class="mobile-only-nav pull-right">
                <ul class="nav navbar-right top-nav pull-right">
                    ...
                    <li class="dropdown full-width-drp">
                        ...
                        ></a>
                        <ul
                            class="dropdown-menu mega-menu pa-0"
                    ...
                    <li class="dropdown alert-drp">
                        <a
                            ...
                            ><span class="top-nav-icon-badge">5</span></a
                        >
                    </li>
                    <li class="dropdown auth-drp">
                        ...
                        >
                            ...
                            <li class="sub-menu show-on-hover">
                                <a
                                    href="#"
                                    class="dropdown-toggle pr-0 level-2-drp"
                                    ><i
                                        class="zmdi zmdi-check text-success"
                                    ></i>
                                    available</a
                                >
                                <ul class="dropdown-menu open-left-side">
                                    ...
                                    <li>
                                        <a href="#"
                                            ><i
                                                class="zmdi zmdi-circle-o text-warning"
                                            ></i
                                            ><span>busy</span></a
                                        >
                                    </li>
...
>>>>>>> 5ed76efdb6db7a9497bef03f1fbe455ef98b0ade
                ...
                >
                    <li>
                        <a
                            ...
                            :data-target="'#' + index"
                            ><div class="pull-left">
                                <i class="mr-20" :class="module[0].icon"></i
                                ><span class="right-nav-text">{{ index }}</span>
                            </div>
                        ...
                        <ul
                            :id="index"
                            class="collapse collapse-level-1 two-col-list"
                        >
                            <li
                                v-for="(sub_module, index) in module"
                                :key="sub_module.sub_module_id"
                            >
                                <router-link :to="sub_module.url">{{
                                    sub_module.description_sub_module
                                }}</router-link>
                            </li>
                        </ul>
                    </li>
                                ...
                                <div class="chat-cmplt-wrap">
                                    <div class="chat-box-wrap">
                                        <div class="add-friend">
                                            ...
                                            <a
                                                href="javascript:void(0)"
                                                class="inline-block text-right txt-grey"
                                        ...
                                        <form
                                            role="search"
                                            class="chat-search pl-15 pr-15 pb-15"
                                        >
                                            <div class="input-group">
                                                <input
                                                    type="text"
                                            ...
                                            >
                                                <div class="panel-body pa-0">
                                                    <div class="chat-content">
                                                        <ul
                                                            class="nicescroll-bar pt-20"
                                                        >
                                                            <li class="friend">
                                                                <div
                                                                    class="friend-msg-wrap"
                                                                >
                                                                    <img
                                                                        class="user-img img-circle block pull-left"
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <div
                                                                            class="msg-per-detail text-right"
                                                                        >
                                                                            <span
                                                                                class="msg-time txt-grey"
                                                                                >2:30
                                                                                PM</span
                                                                            >
                                                                        </div>
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div
                                                            class="input-group-btn attachment"
                                                        >
                                                            <div
                            ...
                            >
                                <div class="message-box-wrap">
                                    ...
                                    <div class="set-height-wrap">
                                        <div
                                            class="streamline message-box nicescroll-bar"
                                        >
                                            <a href="javascript:void(0)">
                                                <div
                                                    class="sl-item unread-message"
                                                >
                                                    <div
                                                        class="sl-avatar avatar avatar-sm avatar-circle"
                                                    >
                                                        <img
                                                    ...
                                                    <div class="sl-content">
                                                        <span
                                                            class="inline-block capitalize-font pull-left message-per"
                                                            >Clay Masse</span
                                                        >
                                                        <span
                                                            class="inline-block font-11 pull-right message-time"
                                                            >12:28 AM</span
                                                        >
                                                        <div
                                                            class="clearfix"
                                                        ></div>
                                                        <span
                                                            class="truncate message-subject"
                                                            >Themeforest message
                                                            sent via your envato
                                                            market profile</span
                                                        >
                                                        <p
                                                            class="txt-grey truncate"
                                                        >
                                                            Neque porro quisquam
                                                            est qui dolorem ipsu
                                                            messm quia dolor sit
                                                            amet, consectetur,
                                                            adipisci velit
                                                        </p>
                                                    </div>
